...
wn.bgpic("C:\Brothers\Charan\Python\MyProjects\Youtube\ChrisThomp\SpaceInvader\pictures\space_invaders_background.gif")

"""wn.delay(0)"""
wn.tracer(0)

wn.register_shape("C:\Brothers\Charan\Python\MyProjects\Youtube\ChrisThomp\SpaceInvader\pictures\invader.gif")
wn.register_shape("C:\Brothers\Charan\Python\MyProjects\Youtube\ChrisThomp\SpaceInvader\pictures\spaceship.gif")
wn.register_shape("C:\Brothers\Charan\Python\MyProjects\Youtube\ChrisThomp\SpaceInvader\pictures\SpaceInvadersLaserDepiction.gif")
...
player.color("blue")
player.shape("C:\Brothers\Charan\Python\MyProjects\Youtube\ChrisThomp\SpaceInvader\pictures\spaceship.gif")
player.penup()
player.speed(0)
...
for i in range (number_of_enemies):
    e=Enemy("C:\Brothers\Charan\Python\MyProjects\Youtube\ChrisThomp\AnimateSprites\Pictures\invader1.gif", "C:\Brothers\Charan\Python\MyProjects\Youtube\ChrisThomp\AnimateSprites\Pictures\invader2.gif")
    enemies.append(e)
...
bullet.color("yellow")
bullet.shape("C:\Brothers\Charan\Python\MyProjects\Youtube\ChrisThomp\SpaceInvader\pictures\SpaceInvadersLaserDepiction.gif")
bullet.penup()
bullet.speed(0)
...
def fire_bullet():
    ...
    if bulletstate=="ready":
        play_sound("C:\Brothers\Charan\Python\MyProjects\Youtube\ChrisThomp\SpaceInvader\Music\laser.wav")
        bulletstate="fire"
        x=player.xcor()
        y=10+player.ycor()
...
pygame.mixer.init()
bgm = pygame.mixer.Sound("C:\Brothers\Charan\Python\MyProjects\Youtube\ChrisThomp\SpaceInvader\Music\C\H.wav")
bgm.set_volume(1.0)
bgm.play(0)
"""play_sound("C:\Brothers\Charan\Python\MyProjects\Youtube\ChrisThomp\SpaceInvader\Music\C\H.wav", 119)"""
...
while True:
    ...
    for enemy in enemies:
        ...
        '''if enemy.ycor()<-250:
            player.hideturtle()
            enemy.hideturtle()
            wn.bgpic("C:\Brothers\Charan\Python\MyProjects\Youtube\ChrisThomp\SpaceInvader\pictures\Game_Over.gif")
            break'''


        if is_collision(bullet, enemy):
            play_sound("C:\Brothers\Charan\Python\MyProjects\Youtube\ChrisThomp\SpaceInvader\Music\explosion.wav")
            bullet.hideturtle()
        ...
        if is_collision(player, enemy):
            ...
            wn.bgpic("C:\Brothers\Charan\Python\MyProjects\Youtube\ChrisThomp\SpaceInvader\pictures\glitch-game-background_23-2148090006.gif")
            break
        if enemy.ycor()<-300:
            q=0
            play_sound("C:\Brothers\Charan\Python\MyProjects\Youtube\ChrisThomp\SpaceInvader\Music\explosion.wav")
        ...
        if Wingame==0:
            ...
            for e in enemies:
                e.hideturtle()
                enemy.setposition(0,1000)
            wn.bgpic("C:\Brothers\Charan\Python\MyProjects\Youtube\ChrisThomp\SpaceInvader\pictures\images.gif")
